...
print(np.split(s1,2))
print(np.split(s1,7))
print(np.split(s1,(3,4)))

# where
w1 = np.arange(1,99,7)
w2 = np.arange(1,80,6).reshape(2,7)

print(w1)
print(w2)
print(np.where(w1==78)) #search in 1D
print(np.where(w2==55)) #search in 2D
print(np.where(w1%2==0)) #search using experssion

# searchsorted 
print(np.searchsorted(w1,71))
print(np.searchsorted(w1, [71,8,43]))
print(np.searchsorted(w1, [71,8,43],side='right'))

# Array Functions 
af = np.arange(1,99,7).reshape(2,7)
# sum 
print(np.sum(af))
print(np.sum(af,axis=0))
print(np.sum(af,axis=1))
# min 
print(np.min(af))
print(np.min(af,axis=0))
print(np.min(af,axis=1))
# max 
print(np.max(af))
print(np.max(af,axis=0))
print(np.max(af,axis=1))
# mean 
print(np.mean(af))
print(np.mean(af,axis=0))
print(np.mean(af,axis=1))
# median 
print(np.median(af))
print(np.median(af,axis=0))
print(np.median(af,axis=1))
# variance
print(np.var(af))
print(np.var(af,axis=0))
print(np.var(af,axis=1))
# stadard diviation 
print(np.std(af))
print(np.std(af,axis=0))
print(np.std(af,axis=1))